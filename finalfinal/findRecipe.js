...
const apiKey = 'de737e83a69541549bd0ead5e58abfff'
                            ...
                            <div class = "col">
                                <div class="card effect shadow p-3 mb-5 bg-body rounded" data-id="${meal.id}" style='transition:1s;'>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="#" class="recipe-btn" style='--clr:#1e9bff'>Recipe</a>
                                        <a href="#" class="ingredients-btn" style='--clr:#1e9bff'>Ingredients</a>
                                        `
...
function mealIngredientsModel(ingredientsArray) {
    let output = `<h3 class="title">Ingredients</h3><div style='display:flex; justify-content:center;'><ul class="fa-ul">`
